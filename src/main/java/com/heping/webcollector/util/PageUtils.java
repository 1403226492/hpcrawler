...
/**
 * Created by Spider on 2017/8/18.
 */
...
//      WebDriver driver = new ChromeDriver();
        ...
        System.setProperty("phantomjs.binary.path", "D:/softtools/phantomjs-2.1.1-windows/phantomjs-2.1.1-windows/phantomjs-2.1.1-windows/bin/phantomjs.exe");
...
//      js.executeScript("function(){}");
    ...
    public static String getPhantomJSDriver(Page page) {
        ...
        try {
            process = rt.exec("D:/softtools/phantomjs-2.1.1-windows/phantomjs-2.1.1-windows/phantomjs-2.1.1-windows/bin/phantomjs.exe" +
